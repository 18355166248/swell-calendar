...
| 文档 | 作用 |
|------|------|
| [tasks/2026-06-19-mobile-adaptation.md](./tasks/2026-06-19-mobile-adaptation.md) | 移动端适配 capability epic（响应式 + 触控 + 四视图），M1/M2/M3/M4/M5 已落地 |
| [tasks/2026-06-23-mobile-remix-visual-sync.md](./tasks/2026-06-23-mobile-remix-visual-sync.md) | 移动端 remix 真源视觉、滚动边界、连续月 / 列表虚拟化与交互性能收口 |
